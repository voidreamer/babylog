...
export const formatNapPrediction = (prediction) => {
    if (!prediction) return null;
...
export const getStatus = (value, benchmark) => {
...
export const getPressureColor = (score) => {
...
export function PredictionsSection({ predictions, isPremium }) {
    return (
...
export function PatternsSection({ patterns, isPremium }) {
    return (
        <section className="insights-section">
            <h2 className="insights-section-title">
                <TrendingUp size={18} />
...
export function TrendsSection({ trends, isPremium }) {
...
export function BenchmarksSection({ benchmarks, today_vs_average }) {
    return (
        <section className="insights-section">
            <h2 className="insights-section-title">
...
export function TodayVsAverageSection({ today_vs_average }) {
    return (
        <section className="insights-section">
            <h2 className="insights-section-title">
                <Calendar size={18} />
