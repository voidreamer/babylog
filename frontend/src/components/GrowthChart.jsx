...
function getAgeMonths(birthDate, measurementDate) {
...
export default function GrowthChart({
    records,
    birthDate,
    metric = 'weight', // 'weight' or 'height'
    gender = 'boy' // 'boy' or 'girl' - default to boy if unknown
}) {
    ...
    }, [records, birthDate, metric]);

    // Combine WHO data with baby's data for charting
    const chartData = useMemo(() => {
        // Start with WHO data
        const data = whoData.map(row => ({
