...
function getPercentileStatus(position) {
...
function getPercentileLabel(position) {
...
export default function GrowthCard({ baby, growthRecords, onRecordAdded, whoData }) {
    ...
    const getWhoDataForAge = (dataSet, ageMonths) => {
