...
export function VisitModal({ babyId, editData, onClose, onSave }) {
...
export function VaccModal({ babyId, editData, onClose, onSave }) {
...
export function MedModal({ babyId, editData, onClose, onSave }) {
...
export function MilestoneModal({ babyId, editData, onClose, onSave }) {
...
export function GrowthModal({ babyId, editData, onClose, onSave }) {
