...
function VisitsPanel({ baby, visits, onDataChanged }) {
...
function VaccinationsPanel({ baby, vaccinations, onDataChanged }) {
    const [isAdding, setIsAdding] = useState(false);
    const [saving, setSaving] = useState(false);
    const [formData, setFormData] = useState({
        vaccine_name: '',
    ...
    const upcomingDue = vaccinations?.filter(v =>
...
function MedicationsPanel({ baby, medications, onDataChanged }) {
    const [isAdding, setIsAdding] = useState(false);
    const [saving, setSaving] = useState(false);
    const [formData, setFormData] = useState({
        medication_name: '',
