              ...
              return (
                <div
                  ...
                  style={{
                    position: 'absolute',
                    ...position,
                    // Selected block floats above the grid — high z-index so
                    // the action row (which overflows :visible) isn't clipped
                    // by neighbouring blocks or the grid container.
                    ...
                    cursor: 'pointer',
                    // overflow: visible is the production trick — on a 30px
                    // point-event block, the action row renders below the
                    // block's box; high z-index keeps it legible above
                    // neighbours.
                    overflow: 'visible',
                    display: 'flex',
                  ...
                  {isSelected && (
                    <div
                      ...
                      style={{
                        ...
                        paddingTop: 6,
                        marginTop: 4,
                        borderTop: `0.5px solid ${style.color}55`,
                      }}
                    >
                      <button
                        type="button"
